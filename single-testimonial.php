...
get_header();
?>
	<div id="primary" class="content-area sr-portfolio-wrap sr-testimonial-wrap">
		<?php
			while ( have_posts() ) :
				the_post();
				...
				<div class="sr-portfolio-header<?php echo $sr_class; ?>" style="<?php echo $sr_image_url; ?>" >
					<div class="container">
						...
						<!--p><?php //echo esc_html_e( wp_trim_words( get_the_content(), 50, '...' ), 'schulte-roofing' ); ?></p-->
						<p>
							<?php if ( has_excerpt() ) {
										the_excerpt();
							} ?>
